...
//		KeePassDataBase db = KeePassDataBaseManager.openDataBase(new File("testing-pass.kdb"), null, "testing");
//		assertNotNull(db);
//	}
//
//	@Test
//	public void openKeyFileKdb() throws Exception {
//		KeePassDataBase keePassDb = KeePassDataBaseManager.openDataBase(new File("testing-key.kdb"), new File("testing-key.key"), null);
...
//		KeePassDataBase keePassDb = KeePassDataBaseManager.openDataBase(new File("testing-pass-key.kdb"), new File("testing-key.key"), "testing");
//		KeePassDataBaseV1 kdb1 = (KeePassDataBaseV1) keePassDb;
//		System.out.println(kdb1.getGroups());
//		System.out.println(kdb1.getEntries());
//		assertNotNull(keePassDb);
...
//		try{
//		KeePassDataBaseManager.openDataBase(new File("testing-pass.kdb"), null, null);
...
//		try {
//			KeePassDataBaseManager.openDataBase(new File("testing-pass.kdbx"), null, "testing");
