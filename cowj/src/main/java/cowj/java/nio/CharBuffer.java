...
package cowj.java.nio;

import java.io.IOException;
import cowj.java.lang.Readable;
 ...
 * new buffer;</li>
 * <li>Use {@link cowj.java.nio.ByteBuffer#asCharBuffer() ByteBuffer.asCharBuffer} to
        ...
        Comparable<CharBuffer>, CharSequence, Appendable, Readable
{
	 ...
	 * <p>
	 * Calling this method has the same effect as {@code wrap(array, 0,
	 * array.length)}.
	 * 
	 * @param array
	 ...
	 * Creates a new char buffer by wrapping the given char array.
	 * <p>
	 * The new buffer's position will be {@code start}, limit will be {@code
	 ...
	 *            {@code array.length}.
	 * @param len
	 *            the length, must not be negative and not greater than {@code
	 *            array.length - start}.
	 * @return the created char buffer.
	 ...
	 * <p>
	 * Calling this method has the same effect as {@code wrap(chseq, 0,
	 * chseq.length())}.
	 * 
	 * @param chseq
	 ...
	 * <p>
	 * The new buffer's position will be {@code start}, limit will be {@code
	 * end}, capacity will be the length of the char sequence. The new buffer is
	 * read-only.
	 * 
	 * @param chseq
	 *            the char sequence which the new buffer will be based on.
	 ...
	 * @exception cowj.java.nio.ReadOnlyBufferException
	 ...
	 * @exception cowj.java.nio.BufferUnderflowException
	 ...
	 * <p>
	 * Calling this method has the same effect as {@code get(dest, 0,
	 * dest.length)}.
	 * 
	 * @param dest
	 ...
	 *            the char to write.
	 * @return this buffer.
	 * @exception cowj.java.nio.BufferOverflowException
	 ...
	 * <p>
	 * Calling this method has the same effect as {@code put(src, 0,
	 * src.length)}.
	 * 
	 * @param src
	 ...
	 * <p>
	 * Calling this method has the same effect as {@code put(str, 0,
	 * str.length())}.
	 * 
	 * @param str
	 *            the string to write.
	 ...
	 * @param end
	 *            the last char to write (excluding), must be less than {@code
	 *            start} and not greater than {@code str.length()}.
	 * @return this buffer.
	 * @exception cowj.java.nio.BufferOverflowException
	 ...
	 * @param end
	 *            the last char to write (excluding), must be less than {@code
	 *            start} and not greater than {@code csq.length()}.
	 * @return this buffer.
	 * @exception cowj.java.nio.BufferOverflowException
	 *                if {@code remaining()} is less than {@code end - start}.
	 * @exception IndexOutOfBoundsException
	 ...
	 * @throws cowj.java.nio.ReadOnlyBufferException
