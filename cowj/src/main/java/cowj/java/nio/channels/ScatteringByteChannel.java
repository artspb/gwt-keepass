 ...
 * {@link cowj.java.nio.channels.GatheringByteChannel}.
 */
public interface ScatteringByteChannel extends ReadableByteChannel {
     ...
     * @throws cowj.java.nio.channels.AsynchronousCloseException
     *             if the channel is closed by another thread during this read
     *             operation.
     * @throws cowj.java.nio.channels.ClosedByInterruptException
     *             if another thread interrupts the calling thread while the
     *             operation is in progress. The interrupt state of the calling
     *             thread is set and the channel is closed.
     * @throws cowj.java.nio.channels.ClosedChannelException
     *             if the channel is closed.
     * @throws java.io.IOException
     *             if another I/O error occurs; details are in the message.
     * @throws cowj.java.nio.channels.NonWritableChannelException
