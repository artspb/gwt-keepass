...
public class ZipOutputStream extends DeflaterOutputStream implements ZipConstants
{
   ...
   * @see cowj.java.util.zip.Deflater
   */
   ...
   * @exception cowj.java.util.zip.ZipException if stream was finished.
   */
   ...
   * @exception java.io.IOException if an I/O error occured.
   * @exception cowj.java.util.zip.ZipException if no entry is active.
   */
