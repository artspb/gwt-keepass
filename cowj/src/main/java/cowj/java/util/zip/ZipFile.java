...
import cowj.java.io.BufferedInputStream;
import cowj.java.io.DataInput;
import cowj.java.io.EOFException;
import cowj.java.io.File;
import cowj.java.io.InputStream;
import cowj.java.io.RandomAccessFile;
...
public class ZipFile implements ZipConstants
{
   ...
   * @exception java.io.IOException if a i/o error occured.
   ...
   *
   * @exception java.io.IOException if a i/o error occured.
   * @exception cowj.java.io.EOFException if the file ends prematurely
   */
  ...
  private static class ZipEntryEnumeration implements Enumeration
  {
    ...
    public Object nextElement()
    {
      ...
      /* dg: no we don't, GWT doesn't do clones.
      return ((ZipEntry)elements.next()).clone();
      */
    	
      return ((ZipEntry)elements.next());
    }
  }
