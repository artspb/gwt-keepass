 ...
 * {@link cowj.java.io.DataOutput}. Types that can be read include byte, 16-bit short, 32-bit
 ...
 *
 * @see cowj.java.io.DataInputStream
 * @see cowj.java.io.RandomAccessFile
 */
public interface DataInput {
     ...
     * @throws cowj.java.io.EOFException if the end of the input is reached before the read
     *         request can be satisfied.
     * @throws java.io.IOException
     *             if an I/O error occurs while reading.
     * @see cowj.java.io.DataOutput#writeBoolean(boolean)
     */
     ...
     * @throws java.io.IOException
     *             if an I/O error occurs while reading.
     * @see cowj.java.io.DataOutput#writeByte(int)
     */
     ...
     * @throws java.io.IOException
     *             if an I/O error occurs while reading.
     * @see cowj.java.io.DataOutput#writeChar(int)
     */
     ...
     * @throws java.io.IOException
     *             if an I/O error occurs while reading.
     * @see cowj.java.io.DataOutput#writeDouble(double)
     */
     ...
     * @throws java.io.IOException
     *             if an I/O error occurs while reading.
     * @see cowj.java.io.DataOutput#writeFloat(float)
     */
     ...
     * @throws java.io.IOException
     *             if an I/O error occurs while reading.
     * @see cowj.java.io.DataOutput#write(byte[])
     * @see cowj.java.io.DataOutput#write(byte[], int, int)
     */
     ...
     * @throws java.io.IOException
     *             if an I/O error occurs while reading.
     * @see cowj.java.io.DataOutput#writeInt(int)
     */
     ...
     * @throws java.io.IOException
     *             if an I/O error occurs while reading.
     * @see cowj.java.io.DataOutput#writeLong(long)
     */
     ...
     * @throws java.io.IOException
     *             if an I/O error occurs while reading.
     * @see cowj.java.io.DataOutput#writeShort(int)
     */
    ...
    /**
     * Reads a string encoded with {@link cowj.java.io.DataInput modified UTF-8}.
     * 
     * @return the next string encoded with {@link cowj.java.io.DataInput modified UTF-8}.
     * @throws cowj.java.io.EOFException if the end of the input is reached before the read
     *         request can be satisfied.
     * @throws java.io.IOException
     *             if an I/O error occurs while reading.
     * @see cowj.java.io.DataOutput#writeUTF(String)
     */
    public abstract String readUTF() throws IOException;

    /**
     * Skips {@code count} number of bytes. This method will not throw an
     * {@link cowj.java.io.EOFException} if the end of the input is reached before
