...
import cowj.java.io.InputStreamReader;
...
import cowj.org.apache.james.mime4j.io.BufferedLineReaderInputStream;
import cowj.org.apache.james.mime4j.io.LineNumberInputStream;
import cowj.org.apache.james.mime4j.io.LineNumberSource;
 ...
 *      }
 * </pre>
 * <p>Instances of {@link cowj.org.apache.james.mime4j.parser.MimeTokenStream} are reusable: Invoking the
 * method {@link #parse(cowj.java.io.InputStream)} resets the token streams internal
...
public class MimeTokenStream implements EntityStates, RecursionMode {
     ...
     * to 
     * {@link ContentHandler#startMultipart(cowj.org.apache.james.mime4j.descriptor.BodyDescriptor)},
     ...
     * @throws IllegalStateException {@link #getState()} returns an
     *   invalid value 
     * @throws cowj.java.nio.charset.UnsupportedCharsetException if there is no JVM support
     * for decoding the charset
     * @throws cowj.java.nio.charset.IllegalCharsetNameException if the charset name specified
