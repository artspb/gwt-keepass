...
import cowj.org.apache.james.mime4j.storage.MultiReferenceStorage;
import cowj.org.apache.james.mime4j.storage.Storage;
import cowj.org.apache.james.mime4j.storage.StorageProvider;
import cowj.org.apache.james.mime4j.util.CharsetUtil;
...
public class BodyFactory {
    ...
    /**
     * Creates a {@link cowj.org.apache.james.mime4j.message.BinaryBody} that holds the content of the given input
     * stream.
     * 
     * @param is
    ...
    /**
     * Creates a {@link cowj.org.apache.james.mime4j.message.BinaryBody} that holds the content of the given
     * {@link cowj.org.apache.james.mime4j.storage.Storage}.
     * <p>
     * Note that the caller must not invoke {@link cowj.org.apache.james.mime4j.storage.Storage#delete() delete()} on
     ...
     * {@link cowj.org.apache.james.mime4j.message.Disposable#dispose()}).
     * 
     * @param storage
    ...
    /**
     * Creates a {@link cowj.org.apache.james.mime4j.message.TextBody} that holds the content of the given input
     * stream.
     * <p>
     * &quot;us-ascii&quot; is used to decode the byte content of the
     * <code>Storage</code> into a character stream when calling
     * {@link cowj.org.apache.james.mime4j.message.TextBody#getReader() getReader()} on the returned object.
     * 
     * @param is
     *            input stream to create a message body from.
     * @return a text body.
     ...
     * calling {@link cowj.org.apache.james.mime4j.message.TextBody#getReader() getReader()} on the returned object.
    ...
    /**
     * Creates a {@link cowj.org.apache.james.mime4j.message.TextBody} that holds the content of the given
     * {@link cowj.org.apache.james.mime4j.storage.Storage}.
     * <p>
     * &quot;us-ascii&quot; is used to decode the byte content of the
     * <code>Storage</code> into a character stream when calling
     ...
     * stream when calling {@link cowj.org.apache.james.mime4j.message.TextBody#getReader() getReader()} on the
    ...
    /**
     * Creates a {@link cowj.org.apache.james.mime4j.message.TextBody} that holds the content of the given string.
     * <p>
     * &quot;us-ascii&quot; is used to encode the characters of the string into
     * a byte stream when calling
     * {@link cowj.org.apache.james.mime4j.message.SingleBody#writeTo(java.io.OutputStream) writeTo(OutputStream)} on
     * the returned object.
     * 
     * @param text
