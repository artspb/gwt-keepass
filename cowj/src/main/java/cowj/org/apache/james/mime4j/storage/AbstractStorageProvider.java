...
import cowj.org.apache.james.mime4j.codec.CodecUtil;

/**
 * Abstract implementation of {@link cowj.org.apache.james.mime4j.storage.StorageProvider} that implements
 * {@link cowj.org.apache.james.mime4j.storage.StorageProvider#store(cowj.java.io.InputStream) store(InputStream)} by copying the
 * input stream to a {@link StorageOutputStream} obtained from
 * {@link cowj.org.apache.james.mime4j.storage.StorageProvider#createStorageOutputStream() createStorageOutputStream()}.
 */
