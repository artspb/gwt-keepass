...
import cowj.org.apache.james.mime4j.field.contentdisposition.parser.ContentDispositionParser;
import cowj.org.apache.james.mime4j.field.contenttype.parser.TokenMgrError;
...
public class ContentDispositionField extends AbstractField {
    ...
    private Date parseDate(String paramName) {
        ...
        try {
            ...
            return null;
        } catch (cowj.org.apache.james.mime4j.field.datetime.parser.TokenMgrError e) {
            if (log.isDebugEnabled()) {
                log.debug("Parsing " + paramName + " '" + value + "': "
                        + e.getMessage());
            }
    ...
    private void parse() {
        ...
        if (dispositionType != null) {
            this.dispositionType = dispositionType.toLowerCase();
