...
public class MimeStreamParser {
    ...
    public MimeStreamParser(final MimeEntityConfig config) {
        ...
        if (config != null) {
            localConfig = new MimeEntityConfig(config);
        } else {
     ...
     * @throws cowj.org.apache.james.mime4j.MimeException if the message can not be processed
     ...
     * {@link cowj.org.apache.james.mime4j.parser.ContentHandler#raw(cowj.java.io.InputStream)} handler method only.
     ...
     * will still call 
     * {@link cowj.org.apache.james.mime4j.parser.ContentHandler#endMultipart()},
     * {@link cowj.org.apache.james.mime4j.parser.ContentHandler#endBodyPart()},
     * {@link cowj.org.apache.james.mime4j.parser.ContentHandler#endMessage()}, etc to match previous calls
     * to 
     * {@link cowj.org.apache.james.mime4j.parser.ContentHandler#startMultipart(cowj.org.apache.james.mime4j.descriptor.BodyDescriptor)},
     * {@link cowj.org.apache.james.mime4j.parser.ContentHandler#startBodyPart()},
     * {@link cowj.org.apache.james.mime4j.parser.ContentHandler#startMessage()}, etc.
     */
    public void stop() {
