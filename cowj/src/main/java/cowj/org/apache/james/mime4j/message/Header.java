...
public class Header implements Iterable<Field> {
     ...
     * with a copy of the list of {@link cowj.org.apache.james.mime4j.parser.Field}s of the specified
     ...
     * @throws cowj.org.apache.james.mime4j.MimeIOException on MIME protocol violations.
     */
     ...
     * of fields (same behavior as {@link #addField(cowj.org.apache.james.mime4j.parser.Field)}). Otherwise the
