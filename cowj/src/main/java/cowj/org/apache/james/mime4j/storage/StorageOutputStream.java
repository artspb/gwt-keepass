 ...
 * {@link cowj.org.apache.james.mime4j.storage.StorageProvider#createStorageOutputStream()}. The user can then write
...
public abstract class StorageOutputStream extends OutputStream {
     ...
     * <p>
     * This implementation never throws an {@link java.io.IOException} but a subclass
     * might.
     * 
     * @throws java.io.IOException
     *             if an I/O error occurs.
