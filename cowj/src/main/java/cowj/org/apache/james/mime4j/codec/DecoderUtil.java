...
package cowj.org.apache.james.mime4j.codec;

import java.io.IOException;
import java.io.UnsupportedEncodingException;
import cowj.java.io.ByteArrayInputStream;
...
public class DecoderUtil {
    ...
    public static byte[] decodeBase64(String s) {
        ...
        try {
            byte[] bytes = CharsetUtil.getTrivialBytes(s);
    ...
    public static String decodeB(String encodedWord, String charset) 
        ...
        return CharsetUtil.decodeString(decodeBase64(encodedWord), charset);
    }
    ...
    public static String decodeQ(String encodedWord, String charset)
        ...
        return CharsetUtil.decodeString(decodeBaseQuotedPrintable(sb.toString()), charset);
    }
    ...
    public static String decodeEncodedWords(String body) {
        ...
        while (true) {
            ...
            int end = begin;
            /* dg --- code here fixes bug MIME4J-138. We can't use their fix
             * because it uses regexps.
             * https://issues.apache.org/jira/browse/MIME4J-138
             */
            if (begin != -1)
            {
            	int q1 = body.indexOf('?', begin+2);
            	if (q1 != -1)
            	{
            		int q2 = body.indexOf('?', q1+1);
            		if (q2 != -1)
            			end = body.indexOf("?=", q2+1);
            	}
            }
            if (end == -1) {
                if (previousEnd == 0)
