...
//implements Cloneable 
{
    ...
    public MimeEntityConfig(MimeEntityConfig other)
    {
        this.maximalBodyDescriptor = other.maximalBodyDescriptor;
        this.strictParsing = other.strictParsing;
        this.maxLineLen = other.maxLineLen;
        this.maxHeaderCount = other.maxHeaderCount;
        this.maxContentLen = other.maxContentLen;
        this.countLineNumbers = other.countLineNumbers;
    }
     ...
     * tolerated or should result in a {@link cowj.org.apache.james.mime4j.MimeException}. If this parameter
     ...
     * with a {@link cowj.org.apache.james.mime4j.MimeException} if a line is encountered that exceeds the maximum
     ...
     * with a {@link cowj.org.apache.james.mime4j.MimeException} if the number of headers exceeds the maximum
     ...
     * with a {@link cowj.org.apache.james.mime4j.MimeException} if a content body exceeds the maximum length limit.
